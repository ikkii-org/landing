...
export default function HowItWorks() {
    ...
    return (
        <section id="how-it-works" className="section" ref={ref}>
            <div className="glow-orb" style={{ width: 600, height: 600, background: 'radial-gradient(circle, rgba(139,92,246,0.07) 0%, transparent 70%)', top: '50%', left: '50%', transform: 'translate(-50%,-50%)' }} />
            ...
            <div className="container" style={{ position: 'relative', zIndex: 1 }}>
                ...
                <div style={{ maxWidth: 880, margin: '0 auto', position: 'relative' }}>
                    ...
                    <div className="hiw-line-wrap" style={{ position: 'absolute', top: 40, bottom: 40, left: '50%', width: 2, transform: 'translateX(-50%)', zIndex: 0 }}>
                        <div style={{ width: '100%', height: '100%', background: 'var(--border)', borderRadius: 2 }} />
                        <motion.div
                            initial={{ height: '0%' }}
                            animate={inView ? { height: '100%' } : {}}
                            transition={{ duration: 2, ease: 'easeInOut' }}
                            style={{ position: 'absolute', top: 0, left: 0, width: '100%', background: 'linear-gradient(to bottom, transparent, var(--purple-light), var(--cyan), transparent)', borderRadius: 2 }}
                        />
                    </div>
                            ...
                            return (
                                <div key={i} className={`hiw-row ${isEven ? 'hiw-even' : 'hiw-odd'}`}>
                                    ...
                                    <motion.div
                                        ...
                                        className="hiw-node"
                                        style={{ background: 'var(--bg0)', border: `2px solid ${step.color}` }}
                                    >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {/* Glow */}
                                            <div style={{ position: 'absolute', top: -30, left: '50%', transform: 'translateX(-50%)', width: 100, height: 60, background: step.color, filter: 'blur(40px)', opacity: 0.1, pointerEvents: 'none' }} />
                                            ...
                                            <div style={{ display: 'flex', gap: 20, alignItems: 'flex-start' }}>
                                                ...
                                                <div>
                                                    ...
                                                    <h3 style={{ fontSize: 22, fontWeight: 700, marginBottom: 12, color: 'var(--text1)', lineHeight: 1.2 }}>
                                                        {step.title}
                                                    </h3>
            ...
            <style>{`
                ...
                .hiw-even .hiw-card-wrap { grid-column: 1; }
